...
function addParticle()
	for currentParticle = 1, limit do
		...
		Particle[currentParticle].body:setMass(Particle[currentParticle].size / 160)
...
function addDeathParticle()
	for currentDeathParticle = 1, deathLimit do
		...
		DeathParticle[currentDeathParticle].body:setMass(DeathParticle[currentDeathParticle].size / 300)
